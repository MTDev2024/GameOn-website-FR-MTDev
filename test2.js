...
//Event ouvrir modale formulaire
modalBtn.forEach((btn) => btn.addEventListener("click", launchModal));

//Event fermer modale formulaire
closeBtn.addEventListener("click", closeModal);

// Event fermer modale confirmation
closeButton.addEventListener("click", closeConfirmationModal);

// Fermer modales avec touche Échap
...
form.addEventListener("submit", (event) => {
  ...
  if (validate()) {
    // Formulaire validé -> afficher message, récupérer données et ouvrir modale confirmation
    ...
    // Fermer la modale formulaire et ouvrir la modale confirmation
    closeModal();
    openConfirmationModal();
  } else {
    // Formulaire invalide : vider message de succès
    const validMessage = document.getElementById("valid-message");
